...
'''
    ...
    The run method should expect a submission object which it can use to set
    up and run the required test. This will contain information such as the
    path to the file/s to test. It then must return a result object which 
...
class ut1:
    ...
    def run(self, submission):
        ...
        print("Calling make in "+submission.workingPath)        
        output = subprocess.run(['make', '-C', submission.workingPath], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
